...
float phase_voltage[] = {0, 5.6, 7.4, 7.4, 7.4, 5.6, 7.4, 7.4, 5.2, 0, 0, 0, 0};
#define MIN_VOLT 5.6
#define MAX_VOLT 7.4
#define BAT_AH          4
#define BAT_TEMP_COMP   30           //mV per°C under 25°C
#define BAT_CURRENT_HYSTERESIS 100   //mV difference between charging/discharging voltage @ 1A for evaluation of charging percentage
